...
class StudentProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_profile" do
    assert_difference('StudentProfile.count') do
      post student_profiles_url, params: { student_profile: { description: @student_profile.description, student_image: @student_profile.student_image } }
    end
  ...
  test "should update student_profile" do
    patch student_profile_url(@student_profile), params: { student_profile: { description: @student_profile.description, student_image: @student_profile.student_image } }
